...
void experiment1(int numIntegers) {
	...
	cout << "(EXP1.1) Tree1 AVL validation: " << (testBSTOrder1 && testBalanced1 &&
		testContains1) << endl;
	cout << " BST order: " << testBSTOrder1 << "; AVL balanced: " <<
		testBalanced1 << "; Contains generated odd int only: " << testContains1 << endl;
	bool testBSTOrder2 = testBST(tree2);
	bool testBalanced2 = testBalanced(tree2);
	bool testContains2 = testContains(tree2, numIntegers);
	cout << "(EXP1.2) Tree2 AVL validation: " << (testBSTOrder2 && testBalanced2)
		<< endl;
	cout << " BST order: " << testBSTOrder2 << "; AVL balanced: " <<
		testBalanced2 << "; Contains generated odd int only: " << testContains2 << endl;
	bool testBSTOrder3 = testBST(tree3);
	bool testBalanced3 = testBalanced(tree3);
	bool testContains3 = testContains(tree3, numIntegers);
	cout << "(EXP1.3) Tree3 AVL validation: " << (testBSTOrder3 && testBalanced3)
		<< endl;
	cout << " BST order: " << testBSTOrder3 << "; AVL balanced: " <<
		testBalanced3 << "; Contains generated odd int only: " << testContains3 << endl;
	if (testBSTOrder1 && testBalanced1 && testContains1 && testBSTOrder2 &&
		testBalanced2 && testContains2 && testBSTOrder3 && testBalanced3 && testContains3)
	{
		cout << "(EXP1.4) Conclusion: my AVL tree implementation is correct" <<
			endl;
	}
	else
	{
		cout << "(EXP1.4) Conclusion: my AVL tree implementation is incorrect" <<
			endl;
	}
	delete tree1;
	delete tree2;
...
void stage1(AVLTree<int>* avl, int numIntegers) {
	// compute how many extra data we will insert into AVL compared with Figure
	...
	cout << "(EXP2.1) Inserted " << numIntegers << " random integers. " <<
	...
	cout << "(EXP2.5) The average depth: " << averageDepth << " (v.s. log2(n)=" <<
		log2(numIntegers) << ")" << endl;
...
void stage2(AVLTree<int>* avl, int numRandomInsertRemove) {
	...
	cout << "(EXP2.9) Compute height (DFS): " << avl->computeHeight()
		<< "; root-> height: " << avl->readRootHeight() << endl;
	cout << " testHeigth? " << testHeight(avl) << endl;
	...
	cout << "(EXP2.10) New average depth: " << newAverageDepth << " (v.s. log2(n)="
		<< log2(numIntegers) << ")" << endl;
